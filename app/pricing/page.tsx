...
const TIERS: Tier[] = [
  {
    ...
    name: 'Free',
    price: 'Free',
    description: 'Get a feel for the strategy with full access to theme rankings and educational content.',
    cta: 'Start Free',
    ctaHref: '/rankings',
    recommended: false,
    features: [
      { text: 'View all 19 theme momentum rankings', included: true  },
      { text: 'Theme momentum scores & vs SPY',      included: true  },
      { text: 'FAQ & How It Works',                  included: true  },
      { text: 'Constituent stock drill-down',        included: false },
      { text: 'Balanced mode picks (top 2 themes)',  included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Constituent stocks per theme with RS data', included: true },
      { text: 'Balanced mode picks (top 2 themes)',        included: true },
  ...
  },
  {
    ...
    name: 'Premium',
    price: 99,
    description: 'Growth mode: 61.34% CAGR, concentrated single-theme allocation. For experienced investors who can handle -75.9% drawdowns.',
    cta: 'Contact Sales',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. The Free tier (Explorer) has no time limit and requires no credit card. You can access theme rankings and momentum scores indefinitely at no cost.',
  },
  {
